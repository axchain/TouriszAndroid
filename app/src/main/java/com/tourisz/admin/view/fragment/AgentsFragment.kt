...
import com.tourisz.admin.adapter.AgentsAdapter
import com.tourisz.api.URLS
import com.tourisz.api.response.AgentsData
import com.tourisz.api.response.AgentsListResponse
...
class AgentsFragment : Fragment() {
    ...
    public fun onAgentsListItemClick(agentsData: AgentsData) {
        listener?.onAgentsListItemClick(agentsData)
    }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onAgentsListItemClick(agentsData: AgentsData)
                ...
                Response.Listener<JSONObject> { response ->
                    ...
                    if (agentsListResponse.result) {
                        if (agentsListResponse.data.size > 0) {
                            ...
                            rvHotel.adapter = AgentsAdapter(agentsListResponse.data, this)
                        } else {
