...
class EventsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mView = inflater.inflate(R.layout.fragment_my_event_bookings, container, false)
    ...
    public fun onEventListItemClick(eventData: EventData) {
        listener?.onEventListItemClick(eventData)
    }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onEventListItemClick(hotelBooking: EventData)
    }
                ...
                Response.Listener<JSONObject> { response ->
                    ...
                    if (hotelListResponse.result) {
                        if (hotelListResponse.data.size > 0) {
                            ...
                            rvHotel.adapter = EventsAdapter(hotelListResponse.data, this)
                        } else {
